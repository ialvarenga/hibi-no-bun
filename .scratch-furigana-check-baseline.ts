import { generateReading } from './.scratch-gr-original'
...
async function main() {
  ...
  for (const [i, s] of scenarios.entries()) {
    console.log(`\n=== Baseline Scenario ${i + 1}: theme=${s.theme} ===`)
  ...
  console.log(`\nBASELINE TOTAL missed kanji across ${scenarios.length} runs:`, totalMissed)
}
